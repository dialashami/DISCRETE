...
int main()
{
	...
	if (x1 == 1) {
		...
		cout << "  to insert new expression enter 5 \n";
		cin >> z;

		if (z == 1) {
			cout << "(aUb)not :\t";
			for (int i = 0; i <= 32; i++) {  /////////// not a 
				if (array1[i] == 1) {
					array1_n[i] = 0;
				}
		...
		if (z == 5) {
			...
			//for (int i = 0; i < 32; i++) {
			//	array3[i] = (array1_n[i] & array2[i] | array2_n[i] & array1[i]);
			//}
			//for (int i = 0; i < 32; i++) {
			//	if (array3[i] == 1) {
			//		array3[i] = i;
